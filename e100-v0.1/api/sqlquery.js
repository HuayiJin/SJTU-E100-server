...
exports.searchVehiclebyVIN_Register = function (car_vin) {
    var searchsql = "select * from CAR_REGISTER_TEST WHERE `car_VIN`='" + car_vin + "'";
    return searchsql;
}

exports.searchVehiclebyVIN_Runtime = function (car_vin, start, end) {
    var searchsql = "select * from CAR_REALTIME_DATA_TEST WHERE `car_VIN`='" + car_vin
        + "' and`timestamp`>'" + start
        + "' and`timestamp`<'" + end + "'";
    return searchsql;
}

exports.searchVehiclebyVIN_Battery = function (car_vin, start, end) {
    var searchsql = "select * from BATTERY_REALTIME_DATA_TEST WHERE `car_VIN`='" + car_vin
        + "' and`timestamp`>'" + start
        + "' and`timestamp`<'" + end + "'";
    return searchsql;
}

exports.searchVehiclebyVIN_Alert = function (car_vin, start, end) {
    var searchsql = "select * from ALERT_DATA_TEST WHERE `car_VIN`='" + car_vin
        + "' and`timestamp`>'" + start
        + "' and`timestamp`<'" + end + "'";
    return searchsql;
}
...
*******************************
*/
exports.searchVehiclebyNUM_Register = function (car_num, start, end) {
...
exports.searchVehiclebyNUM_Runtime = function (car_num, start, end) {
    var searchsql = "select * from CAR_REALTIME_DATA_TEST WHERE `car_VIN`='" + car_num
        + "' and`timestamp`>'" + start
        + "' and`timestamp`<'" + end + "'";
    return searchsql;
}

exports.searchVehiclebyNUM_Battery = function (car_num, start, end) {
    var searchsql = "select * from BATTERY_REALTIME_DATA_TEST WHERE `car_VIN`='" + car_num
        + "' and`timestamp`>'" + start
        + "' and`timestamp`<'" + end + "'";
    return searchsql;
}

exports.searchVehiclebyNUM_Alert = function (car_num, start, end) {
    var searchsql = "select * from ALERT_DATA_TEST WHERE `car_VIN`='" + car_num
        + "' and`timestamp`>'" + start
        + "' and`timestamp`<'" + end + "'";
    return searchsql;
}
