...
--
-- Host: localhost    Database: runoob_db
-- ------------------------------------------------------
...
CREATE TABLE `CAR_REGISTER_TEST` (
  ...
  `energy_storing_type` varchar(45) DEFAULT NULL,
  `drive_motor_type` varchar(45) DEFAULT NULL,
  `drive_motor_rated_power` int(11) DEFAULT NULL,
  `drive_motor_rated_rpm` int(11) DEFAULT NULL,
  `drive_motor_rated_torque` int(11) DEFAULT NULL,
  `drive_motor_number` int(11) DEFAULT NULL,
  `drive_motor_position` varchar(45) DEFAULT NULL,
  `drive_motor_cooling_method` varchar(45) DEFAULT NULL,
  `e_car_endurance_mileage` int(11) DEFAULT NULL,
  `e_car_top_speed` int(11) DEFAULT NULL,
  `power_battery_number` int(11) DEFAULT NULL,
  `power_battery_info_0` varchar(250) DEFAULT NULL,
  `power_battery_info_1` varchar(250) DEFAULT NULL,
  `power_battery_info_2` varchar(250) DEFAULT NULL,
...
-- Dump completed on 2018-10-10 22:23:32
